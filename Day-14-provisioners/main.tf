...
resource "aws_key_pair" "example" {
  key_name   = "task"
  public_key = file("C:/Users/srini/.ssh/id_rsa.pub")
}
...
# EC2 Instance (Ubuntu)
 ...
 ami                         = "ami-0b0b78dcacbab728f" # Ubuntu AMI
...
#  private_key = file("C:/Users/srini/.ssh/id_rsa")  # Path to private key
#  host        = self.public_ip
#  timeout = "2m"
#}
...
resource "null_resource" "run_script" {
  ...
  provisioner "remote-exec" {
    connection {
      ...
      user        = "ec2-user"
      private_key = file("C:/Users/srini/.ssh/id_rsa")
    }
...
# terraform apply/home/ec2-user/file200